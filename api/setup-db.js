...
const ALL_TABLE_SQL = {
  ...
  chat_messages: `CREATE TABLE IF NOT EXISTS public.chat_messages (id BIGSERIAL PRIMARY KEY, room TEXT NOT NULL DEFAULT 'general', author_name TEXT NOT NULL, author_avatar TEXT DEFAULT '', author_provider TEXT DEFAULT '', content TEXT NOT NULL, created_at TIMESTAMPTZ DEFAULT NOW())`,
